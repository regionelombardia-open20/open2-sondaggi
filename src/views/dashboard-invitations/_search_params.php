...
<?php for ($i = 1; $i <= $count; $i++) { ?>
    <div id="row-search-<?= $i ?>" class="row d-flex flex-wrap align-item-center">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4">
            <?php
                $typeValues = $model->field[$i] ? SondaggiInvitationsSearch::getAttributesValues($model->field[$i])  : null;
                $output = null;
                if (!empty($typeValues))
