...
<div class="sondaggi-risposte-sessioni-form">
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'user_profile_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(\lispa\amos\admin\models\UserProfile::find()->all(), 'id', 'id'), ['prompt' => AmosSondaggi::t('amossondaggi', 'Select')]
        );
        ?>
    </div>
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'sondaggi_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(lispa\amos\sondaggi\models\Sondaggi::find()->all(), 'id', 'id'), ['prompt' => AmosSondaggi::t('amossondaggi', 'Select')]
        );
        ?>
    </div>
