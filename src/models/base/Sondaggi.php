...
abstract class Sondaggi extends ContentModel
{
    ...
    public function rules()
    {
        return [
            ...
            [[
                ...
                'additional_emails',
                'thank_you_page',
                'url_sondaggio_non_compilabile',
                'url_chiudi_sondaggio',
                'link_landing_page',
                'testo_sondaggio_non_compilabile_front',
                'titolo_fine_sondaggio_front',
                'testo_fine_sondaggio_front',
                'mail_mittente_nuovo_utente',
                'mail_soggetto_nuovo_utente',
                'mail_contenuto_nuovo_utente',
                'mail_mittente_utente_presente',
                'mail_soggetto_utente_presente',
                'mail_contenuto_utente_presente',
                'mail_registrazione_mittente',
                'mail_registrazione_soggetto',
                'mail_registrazione_corpo',
                'mail_conf_community_mittente',
                'mail_conf_community_soggetto',
                'mail_conf_community_corpo',
                'forza_lingua',
                'publication_date_begin',
            ...
            [[
                ...
                'mail_registrazione_custom',
                'mail_conf_community',
                'mail_conf_community_id',
                'abilita_criteri_valutazione',
                'n_max_valutatori'
            ], 'integer'],
            [[
                'publication_date_begin',
    ...
    public function attributeLabels()
    {
        return [
            ...
            'publication_date_begin' => AmosSondaggi::t('amossondaggi', 'Publication Date Begin'),
            'publication_date_end' => AmosSondaggi::t('amossondaggi', 'Publication Date End'),
            ...
            'url_sondaggio_non_compilabile' => AmosSondaggi::t('amossondaggi', 'Url della pagina di avviso di "Sondaggio non compilabile"'),
            'abilita_registrazione' => AmosSondaggi::t('amossondaggi', 'Abilita registrazione automatica al termine del sondaggio'),
            ...
            'send_pdf_via_email' => AmosSondaggi::t('amossondaggi', ' Al termine del sondaggio, invia il pdf compilato via email'),
    ...
    {
        return $this->hasMany(\open20\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_id' => 'id'])
    ...
    {
        return $this->hasMany(\open20\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_id' => 'id'])
            ->andWhere(['OR', ['sondaggi_domande_tipologie_id' => 10], ['sondaggi_domande_tipologie_id' => 11]]);
    }
    ...
    {
        return $this->hasMany(\open20\amos\sondaggi\models\SondaggiDomandePagine::className(), ['sondaggi_id' => 'id'])
    ...
    {
        return $this->hasMany(\open20\amos\sondaggi\models\SondaggiRisposteSessioni::className(), ['sondaggi_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\open20\amos\sondaggi\models\SondaggiPubblicazione::className(), ['sondaggi_id' => 'id']);
    }
}
