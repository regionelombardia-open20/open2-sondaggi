...
*
    ...
    *
            * @property \lispa\amos\sondaggi\models\PeiAccessiServiziFacilitazione $peiAccessiServiziFacilitazione
            ...
            * @property \lispa\amos\sondaggi\models\SondaggiRisposteSessioni $sondaggiRisposteSessioni
    */
class SondaggiRisposte extends \lispa\amos\core\record\Record
{
/**
* @inheritdoc
*/
...
return [
            ...
            [['sondaggi_domande_id', 'sondaggi_risposte_predefinite_id', 'sondaggi_accessi_servizi_id', 'sondaggi_risposte_sessioni_id', 'created_by', 'updated_by', 'deleted_by', 'version'], 'integer'],
...
return [
    ...
    */
    ...
    {
    return $this->hasOne(\lispa\amos\sondaggi\models\PeiAccessiServiziFacilitazione::className(), ['id' => 'sondaggi_accessi_servizi_id']);
    }
    ...
    */
    ...
    {
    return $this->hasOne(\lispa\amos\sondaggi\models\SondaggiRisposteSessioni::className(), ['id' => 'sondaggi_risposte_sessioni_id']);
    }
}
